...
export default function Chat() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#07090e] bg-grid-pattern text-slate-900 dark:text-slate-100 flex flex-col relative overflow-hidden">
      ...
      {/* Input */}
      <div className="border-t border-slate-200 dark:border-white/[0.06] px-4 sm:px-6 py-3 sm:py-4 flex gap-2 sm:gap-3 bg-slate-50 dark:bg-[#07090e]/90 backdrop-blur-md relative z-10">
        <input
          value={input}
